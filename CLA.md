# SafeHell Individual Contributor License Agreement

**Version 1.0 — 2026-09-11**

Thank you for your interest in contributing to SafeHell (the
"Project"), maintained by the owner of the
[`suiflex/SafeHell`](https://github.com/suiflex/SafeHell) repository and its
successors and assigns (the "Maintainer").
...
Contributions, under different license terms in the future, including both
open source licenses approved by the Open Source Initiative and proprietary or
commercial license terms. The Maintainer agrees that Your Contributions will
always additionally remain available under the terms of the open source license
under which they were originally accepted (currently the Apache License,
Version 2.0).
...
3. If your employer has rights to intellectual property that you create that
   ...
   Contributions on behalf of that employer, or your employer has waived those
   rights.
